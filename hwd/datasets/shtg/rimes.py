...
SHTG_RIMES_LINES_PATH = Path('~/.cache/rimes/shtg_rimes_lines.json.gz').expanduser()

RIMES_URL = 'https://storage.teklia.com/public/rimes2011/RIMES-2011-Lines.zip'
RIMES_ZIP_PATH = Path('~/.cache/rimes/RIMES-2011-Lines.zip').expanduser()
RIMES_DIR_PATH = Path('~/.cache/rimes').expanduser()
