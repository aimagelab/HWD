...
from .distances import EuclideanDistance, FrechetDistance
...
class FIDScore(BaseScore):
    def __init__(self, raise_on_error=False, device='cpu'):
        backbone = InceptionV3Backbone('https://github.com/mseitzer/pytorch-fid/releases/download/fid_weights/pt_inception-2015-12-05-6726825d.pth', device=device)
